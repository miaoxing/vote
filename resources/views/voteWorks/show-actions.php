<div class="m-2 js-submit">
  ...
  <a class="btn btn-block btn-secondary" href="<?= $url->full('votes/%s', $voteWork['voteId']) ?>">更多作品</a>
</div>
    ...
    $.ajax({
      ...
      success: function (ret) {
        ...
        if(ret.code == 1) {
          ...
          if($('.js-last-count').html() > 0) {
            $('.js-last-count').html(parseInt($('.js-last-count').html()) - 1);
          }

          if($('.js-last-count').html() == 0 && $('.js-rank').html() > 1) {
