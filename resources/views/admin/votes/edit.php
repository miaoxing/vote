...
<?= $block->js() ?>
<script>
  require(['form', 'ueditor', 'plugins/app/libs/artTemplate/template.min', 'plugins/app/js/validation', 'plugins/admin/js/range-date-time-picker', 'plugins/admin/js/image-upload'], function (form) {
